...
type PublicLessonItemProps = { lesson: ICourseSectionLesson; index: number };

function PublicLessonItem({ lesson, index }: PublicLessonItemProps) {
...
export default PublicLessonItem;
